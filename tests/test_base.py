...
class BaseTwitterAPITestCase(unittest.TestCase):
    ...
    def load_fixtures(self):
        ...
        self.db.execute('INSERT INTO "user" ("id", "username", "password", "first_name", "last_name", "birth_date") VALUES (1, "testuser1", "{}", "Test", "User", "2016-01-30");'.format(md5(b'user1-pass').hexdigest()))
